...
func TestMigrate_CriaSchemaAPartirDeBancoVazio(t *testing.T) {
	...
	esperadas := []string{
		...
		"provas_etapas", "provas_gabarito_respostas", "provas_gabaritos", "provas_importacao_arquivos", "provas_importacoes", "provas_questoes", "provas_questoes_conteudo", "provas_revisoes", "refresh_tokens", "registros_atividade",
